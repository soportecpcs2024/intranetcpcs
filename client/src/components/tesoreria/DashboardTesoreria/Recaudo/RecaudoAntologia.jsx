...
import ListaClasesAntologia from "./ListarClases/ListarClasesAntologia";

const RecaudoAntologia = () => {
  ...
  return (
    <div className="container-recaudo">
      <div className="container-recaudo-box">
        ...
        <ListaClasesAntologia
          clases={clasesAntologia} // Solo se pasan las clases de Antología
                ...
                const response = await fetch(
                  `${import.meta.env.VITE_BACKEND_URL}/api/recaudo/facturas`,
                  {
                    ...
                    body: JSON.stringify({
                      ...
                      clases: facturaActual.clases.map(({ _id }) => ({
                        claseId: _id,
                      })),
...
export default RecaudoAntologia;
