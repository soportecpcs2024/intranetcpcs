        ...
        <div className="layout-academico-container-header">
          <div className="informes-container">
            ...
            {/* <ul className="informes-lista">
              ...
              <li>
                <NavLink  className="informe-item" to="listar_antologias">Antologías</NavLink>
              </li>
              <li>
              ...
              <li>
                <NavLink className="informe-item" to="listar_prom">Prom</NavLink>
              </li>
            </ul> */}
          </div>
...
export default LayoutTesoreriaAdm;
