    ...
    <>
            ...
            <ul>
              {resultados.map((estudiante) => (
                <li key={estudiante.numDocumento}>
                  ...
                  <p>Documento: {estudiante.grupo}</p>
                  <p>Documento: {estudiante.añoLectivo}</p>
     ...
     <PDFDownloadLink
       document={
         ...
         ): ["PRE-JARDIN","PRE-JARDIN A", "PRE-JARDIN B","JARDIN", "JARDIN A", "JARDIN B","TRANSICIÓN","TRANSICIÓN A", "TRANSICIÓN B",].includes(grupoSelect) ? (
