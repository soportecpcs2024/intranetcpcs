...
import BarChartPromediosGruposPrimaria from "./BarChartPromediosGruposPrimaria";
import PieChartComponentGruposPrimaria from "./PieChartComponentGruposPrimaria";
import "./basicaPrimaria.css";
...
const BasicaPrimaria = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const data = await StudentsSection("primaria");
  ...
  useEffect(() => {
    const fetchDataMateria = async () => {
      try {
        const data = await StudentsSectionPromedioMaterias("primaria");
