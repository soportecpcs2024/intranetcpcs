...
const BarChartComponentAreas = ({ students = [], selectedArea = 'ciencias_naturales', error = null }) => {
  ...
  const groupedData = students.reduce((accumulator, student) => {
    ...
    const promedio = parseFloat(student[selectedArea]); // Obtener el promedio del área seleccionada
    ...
    <div className="bar-chart-container">
      <ResponsiveContainer width="100%" height={250}>
        <BarChart data={data}>
          ...
          <Tooltip />
          <Legend />
          <Bar dataKey="average" name="Promedios por Áreas">
...
export default BarChartComponentAreas;
